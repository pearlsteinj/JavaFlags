 ...
 *
 * For examples, see test classes (e.g FlagDescTestClass).
 *
 * Some notes: - No two flags can have the same flag name. - Flag variable names are camelCase. -
 ...
 *
 * Implementation note: Most data is stored in FlagData proto and accessed by flag. ClassScanner
